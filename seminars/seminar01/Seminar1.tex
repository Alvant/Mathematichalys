...
\begin{document}
  ...
  \begin{equation}
    (x^{\alpha})' = \alpha x^{\alpha - 1},\quad \alpha \in \RR,\ x > 0  % TODO: письмо про это (https://en.wikipedia.org/wiki/Exponentiation#Powers_via_logarithms)
  \end{equation}
